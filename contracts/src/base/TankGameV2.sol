...
contract TankGame is ITankGame, TankGameV2Storage {
  ...
  function move(
    ITankGame.MoveParams calldata params
  ) external override gameStarted isTankOwnerOrDelegate(params.tankId) isTankAlive(params.tankId) {
  ...
  function shoot(
    ITankGame.ShootParams calldata params
  )
    external
    override
    gameStarted
  ...
  function give(
    ITankGame.GiveParams calldata params
  ) external override gameStarted isTankOwnerOrDelegate(params.fromId) isTankAlive(params.fromId) {
    uint256 fromId = params.fromId;
    uint256 toId = params.toId;
  ...
  function upgrade(
    ITankGame.UpgradeParams calldata params
  ) external override gameStarted isTankOwnerOrDelegate(params.tankId) isTankAlive(params.tankId) {
    uint256 tankId = params.tankId;
  ...
  function vote(
    ITankGame.VoteParams calldata params
  )
    external
    override
    gameStarted
