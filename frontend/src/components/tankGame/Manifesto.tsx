      ...
      <Card>
        ...
        <CardContent>
          ...
          {/* <div className="bg-gray-100 text-gray-900 p-6"> */}
            ...
            <p className="text-base mb-4">
              Throughout history, the scope of our achievements has been
              dictated by the strength of trust we share with each other.
              Coordination is what sets us apart from the beasts of the field;
              it has been the driving force behind our evolutionary journey.
            </p>
            ...
            <p className="text-base mb-4">
              Yet, we now find ourselves at a crossroads. Traditional
              institutions that once fortified our trust—like banks,
              governments, and religious organizations—are showing cracks in
              their foundations. The erosion of faith in these institutions,
              along with the globalization of society and the rise of
              secularism, necessitate a new paradigm. The way forward lies in
              robust, decentralized economic systems that technologies like
              blockchain can facilitate.
            </p>
            ...
            <p className="text-base mb-4">
              ...
              trust and coordination. Today, we see an opportunity to advance to
              a new stage powered by blockchains and demonstrated by Tact.
            </p>
            ...
            <p className="text-base mb-4">
              ...
              game mechanics has been limited due to the inherently
              untrustworthy nature of anonymous online opponents. Games that
              thrive on social interaction and trust, like Risk, Mafia, Diplomacy, and
              Catan, fail to translate well into online environments where there
              are no real-world consequences for deception or betrayal.
            </p>
            ...
            <p className="text-base mb-4">
              The advent of blockchain technology, equipped with smart
              contracts, offers a solution. It provides a programmable layer of
              trust, enabling us to form reliable bonds without the need for
              complex social intermediaries.
            </p>
