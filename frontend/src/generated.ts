// Generated by @wagmi/cli@1.2.0 on 7/11/2023 at 3:05:59 PM
import {
  useContractRead,
...
export const gameViewAddress = {
  31337: '0x70e0bA845a1A0F2DA3359C97E0285013525FFC49',
} as const
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'spawnerCooldown', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
  },
...
export const iTankGameAddress = {
  ...
  31337: '0x3fA4E6e03Fbd434A577387924aF39efd3b4b50F2',
} as const
...
export const tankGameABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'z', internalType: 'uint256', type: 'uint256', indexed: false },
    ],
    name: 'Move',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'upgradeCost', internalType: 'uint256', type: 'uint256' },
      { name: 'epochSeconds', internalType: 'uint256', type: 'uint256' },
      { name: 'actionDelaySeconds', internalType: 'uint256', type: 'uint256' },
      { name: 'buyInMinimum', internalType: 'uint256', type: 'uint256' },
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iTankGameABI}__ and `functionName` set to `"commit"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x021dbff4a864aa25c51f0ad2cd73266fde66199d)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x1D738bb3c3D594E248Fdb5234b7Af7a2Ecb7B64D)
 * -
 */
export function useITankGameCommit<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof iTankGameAddress,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        'commit',
        TMode
      > & { address?: Address; chainId?: TChainId; functionName?: 'commit' }
    : UseContractWriteConfig<typeof iTankGameABI, 'commit', TMode> & {
        abi?: never
        address?: never
        chainId?: TChainId
        functionName?: 'commit'
  ...
  const { chain } = useNetwork()
  const chainId = config.chainId ?? chain?.id
  return useContractWrite<typeof iTankGameABI, 'commit', TMode>({
    abi: iTankGameABI,
    address: iTankGameAddress[chainId as keyof typeof iTankGameAddress],
    functionName: 'commit',
    ...config,
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iTankGameABI}__ and `functionName` set to `"commit"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x021dbff4a864aa25c51f0ad2cd73266fde66199d)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x1D738bb3c3D594E248Fdb5234b7Af7a2Ecb7B64D)
 * -
 */
export function usePrepareITankGameCommit(
  config: Omit<
    UsePrepareContractWriteConfig<typeof iTankGameABI, 'commit'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof iTankGameAddress } = {} as any,
) {
  const { chain } = useNetwork()
  ...
  return usePrepareContractWrite({
    ...
    functionName: 'commit',
    ...config,
  } as UsePrepareContractWriteConfig<typeof iTankGameABI, 'commit'>)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link tankGameABI}__ and `functionName` set to `"commit"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x021dbff4a864aa25c51f0ad2cd73266fde66199d)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x1D738bb3c3D594E248Fdb5234b7Af7a2Ecb7B64D)
 * -
 */
export function useTankGameCommit<
  TMode extends WriteContractMode = undefined,
  TChainId extends number = keyof typeof tankGameAddress,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        TMode
      > & { address?: Address; chainId?: TChainId; functionName?: 'commit' }
    : UseContractWriteConfig<typeof tankGameABI, 'commit', TMode> & {
        abi?: never
        address?: never
        chainId?: TChainId
        functionName?: 'commit'
  ...
  const { chain } = useNetwork()
  const chainId = config.chainId ?? chain?.id
  return useContractWrite<typeof tankGameABI, 'commit', TMode>({
    abi: tankGameABI,
    address: tankGameAddress[chainId as keyof typeof tankGameAddress],
    functionName: 'commit',
    ...config,
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link tankGameABI}__ and `functionName` set to `"commit"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x021dbff4a864aa25c51f0ad2cd73266fde66199d)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x1D738bb3c3D594E248Fdb5234b7Af7a2Ecb7B64D)
 * -
 */
export function usePrepareTankGameCommit(
  config: Omit<
    UsePrepareContractWriteConfig<typeof tankGameABI, 'commit'>,
    'abi' | 'address' | 'functionName'
  > & { chainId?: keyof typeof tankGameAddress } = {} as any,
) {
  const { chain } = useNetwork()
  ...
  return usePrepareContractWrite({
    ...
    functionName: 'commit',
    ...config,
  } as UsePrepareContractWriteConfig<typeof tankGameABI, 'commit'>)
}
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link tankGameABI}__ and `eventName` set to `"RevealSet"`.
 *
 * - [__View Contract on Ethereum Etherscan__](https://etherscan.io/address/0x021dbff4a864aa25c51f0ad2cd73266fde66199d)
 * - [__View Contract on Goerli Etherscan__](https://goerli.etherscan.io/address/0x1D738bb3c3D594E248Fdb5234b7Af7a2Ecb7B64D)
 * -
 */
export function useTankGameRevealSetEvent(
  config: Omit<
    UseContractEventConfig<typeof tankGameABI, 'RevealSet'>,
    'abi' | 'address' | 'eventName'
  > & { chainId?: keyof typeof tankGameAddress } = {} as any,
) {
  const { chain } = useNetwork()
  ...
  return useContractEvent({
    ...
    eventName: 'RevealSet',
    ...config,
  } as UseContractEventConfig<typeof tankGameABI, 'RevealSet'>)
}
